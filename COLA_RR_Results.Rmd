...
<!--- modified May 5 after comparison with submitted--->
...
wdir<-getwd()
wdir<-"/Users/dorothybishop/Dropbox/COLA_RR_Analysis" #really need to sort out 'here' - this is not satisfactory
mydir <- paste0(wdir,"/")
...
sess1 <- read.csv(paste0(mydir,dir2,'sess1.csv'))
sess3 <- read.csv(paste0(mydir,dir2,'sess3.csv'))
...
#dichmodels$Chisq<-numformat(dichmodels$Chisq,2) #another command that seems to upset flextable
...
tasks <- read.csv(paste0(mydir,dir2,"task_details.csv"))
