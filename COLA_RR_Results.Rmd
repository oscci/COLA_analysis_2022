...
This prediction was not confirmed. The baseline hypothesis of a single laterality factor was also rejected. A modification of the two-factor model that allowed additional paths from Phonological Decision to Factor 2, and from Sentence Comprehension to Factor 1 gave a good fit. 
...
The finding of a slight bias to right hemisphere lateralisation on the Word Comprehension task remains puzzling. It might be dismissed as a fluke, were it not for the fact that it was found both in the online version of the task (see Table `r tabonlinesummary` and in fTCD (see Table `r ftcdtabnumber`), and on the online task, left-handers showed a stronger effect than right-handers. This consistent picture, however, is challenged by the fact that the correlation between LIs on the online and fTCD versions of the task was close to zero. 
