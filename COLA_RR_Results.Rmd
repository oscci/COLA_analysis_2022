...
<!--- updated May 7---  based on submitted, with some text corrections>
...
A preliminary inspection of correlations between online and fTCD laterality indices (Figure `r fignum`) showed very little relationship between the two, even for the two measures, Word Comprehension and Rhyme Decision, that have analogues in fTCD (Word Decision and Phonological Decision respectively).
