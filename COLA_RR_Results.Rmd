...
As stated in our preregistration: **_we first adopt the simple approach of dichotomising laterality at a cutoff of zero for each task, and then perform a chi-square analysis to test for association with handedness. For 6 measures, we adopt a Bonferroni-corrected alpha level of .02/6 = .003._** 
...
We had preregistered a subsidiary analysis as follows: **_After testing associations for individual measures, we will categorise individuals as either consistently left-lateralised on all tests, or right-lateralised on one or more tests, and conduct a chi-square test contrasting the proportion of left- and right-handers on this composite measure._**  
...
## Attempt to use semoutput package
```{r semoutputs,echo=F}
#It's not clear this really adds anything
usecols<-c("A_P1","B_P2","C_P3","D_R1","E_R2","F_R3","DL_z","RDT_z","WC_z","Handed","randgroup")
semdat<-ddati[,usecols]
semdat2 <- semdat[,1:9]
sem_descriptives(semdat2)
# Uses sjPlot to print a nice looking correlation table
tab_corr(semdat2, na.deletion = "pairwise", digits = 2, triangle = "lower")
