---
title: "Supplement 3: Full SEM output"
...
docov<-function(mydata){
  ...
  mymeans<-numformat(colMeans(mydata[,5:10]),3)
...
```{r modelequivs,echo=F}
load('SEMtab2groups.RData')
pandoc.p(paste("Left-handers, N = ",length(ddati$Handed=='Left')))
docov(ddati[ddati$Handed=='Left',])
pandoc.p("")
pandoc.p(paste("Right-handers, N = ",length(ddati$Handed=='Right')))
