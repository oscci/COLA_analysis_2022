...
```{r lavaanout,echo=F}
#Generic function for displaying lavaan results
lavout <- function(modelname,data,fitname){
...
bigsumfit1<-bigsumfit1[,1:3]
colnames(bigsumfit1)[2:3]<-c('Fit1: Full Sample','Fit1: Selected Sample')
...
## Other supplementals 
Script is being set up so we can also churn out tables for alternative analyses that adhere strictly to preregistration. We've looked at these and it's clear that subject inclusion and baseline timings do not have any major impact on findings. 


<!--Attempt to use semoutput package - tried but fiddly and doesn't add anything-->
