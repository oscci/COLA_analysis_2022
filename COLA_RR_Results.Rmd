...
^b^School of Psychology, Bangor University, UK  
...
useorigbaseline <- 1 #should be set to zero unless creating alternative file for supplement. This will undergo usual processing and then be saved as ddati_origbaseline file which can be read in for the supplement.
