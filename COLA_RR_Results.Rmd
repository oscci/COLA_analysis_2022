...
To justify this approach, we first considered whether either raw or absolute laterality indices were correlated with either of the language screening measures and showed they were not  (Supplementary file `r suppnum<-suppnum+1` `r suppnum`. `r suppcorr<-suppnum`.
...
## Additional analyses  
It seemed possible that the laterality indices might be influenced by either the language status of participants, and/or behavioural scores on the fTCD tasks (number of items generated or percentage correct). Supplementary file `r suppnum` shows relevant analyses indicating that this is not the case. 
