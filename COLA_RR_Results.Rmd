...
![Pirate plot distributions of z-LI scores on online tasks](beh_pirates.jpg)  
...
__Table `r tabnumber`: Proportions of left- and right-handers with between 0 and 6 tasks left-lateralised on fTCD.__    
...
tabnumber <- tabnumber+1
```
Table `r tabnumber`: _Characteristics of tasks__
...
### Supplementary Figure `r suppfignumber`

![Density plots and scatterplot showing relationship between conventional laterality index and z-LI for dichotic listening.](Afig4_DLdens.png)
