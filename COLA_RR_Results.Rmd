...
```
Table `r tabnumber`: _Fit statistics for 1-factor (Model.1F), 2-factor (Model.2F) and modified 2-factor (Model.2Fn) models (N = 209)_
...
Overall, the associations between behavioural and fTCD laterality indices were low enough to give little confidence in the specific pattern of associations. Although the split-half reliability of the online measures was not high, it was not so low as to explain the lack of association with fTCD measures. The main conclusion is that our online behavioural measures of laterality based on speed of responding to lateralised stimuli have little in common with measures of relative blood flow to the two hemispheres while performing the same tasks, and cannot be used as proxy measures.  
...
Gerrits, R., De Clercq, P., Verhelst, H., & Vingerhoets, G. (2020). Evaluating the performance of the visual half field paradigm as a screening tool to detect right hemispheric language dominance. Laterality, 25(6), 722–739. https://doi.org/10.1080/1357650X.2020.1854279  
